...
export function Join() {
  ...
  useGSAP(() => {
    ...
    console.log('[Join] Setting up ScrollTrigger')
    ...
    gsap.from('.join-hed, .join-sub, .mag-btn-wrap', {
      ...
      scrollTrigger: {
        ...
        once: true,
        onEnter: () => {
          console.log('[Join] ScrollTrigger fired!')
        },
      },
    })
    ...
    <section id="join" ref={sectionRef} style={{
      ...
      <div ref={contentRef} style={{ position: 'relative', zIndex: 1, transformStyle: 'preserve-3d' }}>
        ...
        <p className="join-sub reveal" style={{
          ...
          One application. Three programs. Zero ceiling. Tell us where you are and we'll tell you where you're going.
        </p>
